...
def w0():
    ...
    image=Image.open(r"C:\Users\Chait\Downloads\Quiz-Game-main\Quiz-Game-main\img\slide1.jpeg")
...
def w1():
    ...
    from PIL import Image,ImageTk
    image=Image.open(r"C:\Users\Chait\Downloads\Quiz-Game-main\Quiz-Game-main\img\dddd.jpeg")
...
def email():
    ...
    s.starttls()
    s.login("chaitanya.22110114@viit.ac.in","wecandoit")
    message = "Hello "+uname +", Below is the score of the game that you played \n Score="+str(o)
    recipients = ['chaitu0812@gmail.com','chaitanya.22110114@viit.ac.in']
    recipients.append(ename)
    print(recipients)
    s.sendmail("chaitanya.22110114@viit.ac.in", recipients, message)
    s.quit()
...
def rrr():
    ...
    from PIL import Image,ImageTk
    image=Image.open(r"C:\Users\Chait\Downloads\Quiz-Game-main\Quiz-Game-main\img\ffff.jpeg")
...
def leaderboard():
    ...
    import pandas as pd
    global a,df
    df=pd.read_excel(r'"C:\Users\Chait\OneDrive\Documents\QUIZ_GAME.xlsx"')
...
def save_data():
    ...
    uname=user_name.get()
    ename=em_ail.get()
    wb= load_workbook(r'"C:\Users\Chait\OneDrive\Documents\QUIZ_GAME.xlsx"')
    ...
    wb.save(r'"C:\Users\Chait\OneDrive\Documents\QUIZ_GAME.xlsx"')
w0()
